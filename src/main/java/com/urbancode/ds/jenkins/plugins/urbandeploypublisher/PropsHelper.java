...
public class PropsHelper {
    ...
    public void setComponentVersionProperties(String url, String componentName, String versionName, String properties, String user, String pass, BuildListener listener) {
